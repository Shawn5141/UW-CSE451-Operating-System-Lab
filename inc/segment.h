...
#define KERNEL_DS_DESC                                                         \
  (SEG_P | SEG_S | SEG_DPL(KERNEL_PL) | SEG_A | SEG_W | SEG_G)
...
static inline void set_gate_desc(struct gate_desc *gd, bool istrap,
                                 uint16_t sel, void *ptr, int dpl) {
